...
<body>
    ...
    <h3><a href="{{route('verify',['token'=>$client->verification->verify_token])}}">Click here</a>to verify your details </h3>
    <h3>or <a href="{{route('notVerify',['token'=>$client->verification->not_verify_token])}}">Click here</a>if you are not satisfied and want to edit </h3>
</body>
</html>