                ...
                <div class="card-body no-padding height-9">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<input type="text" name="name_authorized_signatory" class="form-control" required>
						</div>
						<div class="col-md-4">
							<label for="designation_authorized_signatory">Designation Of Authorized Signatory:</label>
							<input type="text" name="designation_authorized_signatory" class="form-control" required>
						</div>
					</div>
                </div>
            </div>
            ...
            <div class="card card-box">
                ...
                <div class="card-body no-padding height-9">
                	<div class="row">
                		...
                		<div class="col-md-6">
							<input type="email" name="declaration_email_one" class="form-control" placeholder="Enter Email" required>
						</div>
						<div class="col-md-6">
            ...
            <div class="card card-box">
                ...
                <div class="card-body no-padding height-9">
                	<div class="row">
                		<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I Hereby certify that the details furnished above are accurate and true to the best of my knowledge Place.</strong><br><br>
                		<div class="col-md-6">
							<input type="email" name="declaration_email_two" class="form-control" placeholder="Enter Email" required>
						</div>
						<div class="col-md-6">
